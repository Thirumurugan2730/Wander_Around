...
/**
 * Visible Wind Trails, Traveling 10-Second Wind Wave, & Floating Atmospheric Motes.
 * The wind visually sweeps across the sky from LEFT → CENTER → RIGHT on a 10-second cadence.
 */
export default function WindLayer() {
  return (
    <div className="wind-layer" aria-hidden="true">
      ...
      <svg className="wind-svg" viewBox="0 0 1600 900" fill="none" preserveAspectRatio="none">
        ...
        <defs>
          ...
          <linearGradient id="windSunGrad" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="55%" stopColor="#FFECA8" stopOpacity="0.85" />
      ...
      {/* Physically Traveling 10-Second Wind Wave (Sweeps Left → Center → Right) */}

 ...
 */
export default function CloudSilhouette({ variant = 0, className = '' }) {
  const v = variant % 4;
  ...
  if (v === 0) {
    ...
    return (
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="cloudGrad0" x1="170" y1="10" x2="170" y2="180" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.98" />
            <stop offset="70%" stopColor="#FBF8F4" stopOpacity="0.94" />
            <stop offset="100%" stopColor="#EBF0F5" stopOpacity="0.88" />
          </linearGradient>
        </defs>
      </svg>
    );
  ...
  if (v === 1) {
    ...
    return (
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="cloudGrad1" x1="160" y1="8" x2="160" y2="174" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.98" />
            <stop offset="65%" stopColor="#FAF7F2" stopOpacity="0.95" />
            <stop offset="100%" stopColor="#E8EFF5" stopOpacity="0.86" />
          </linearGradient>
        </defs>
      </svg>
    );
  ...
  if (v === 2) {
    ...
    return (
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="cloudGrad2" x1="175" y1="8" x2="175" y2="188" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.98" />
            <stop offset="70%" stopColor="#FFF9F5" stopOpacity="0.94" />
            <stop offset="100%" stopColor="#E8EEF4" stopOpacity="0.88" />
          </linearGradient>
        </defs>
      </svg>
    );
  ...
  return (
    ...
    >
      ...
      />
      <defs>
        <linearGradient id="cloudGrad3" x1="155" y1="10" x2="155" y2="168" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.98" />
          <stop offset="65%" stopColor="#FAF6F2" stopOpacity="0.95" />
          <stop offset="100%" stopColor="#EBF1F6" stopOpacity="0.87" />
        </linearGradient>
      </defs>
    </svg>
  );
